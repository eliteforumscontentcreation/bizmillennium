      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container-wide">
          <Tabs defaultValue="conferences" className="w-full">
            <TabsList className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 mb-12 bg-transparent h-auto p-0">
              <TabsTrigger 
                value="conferences" 
                className="gap-2 justify-start h-12 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-border"
              >
            ...
            <TabsContent value="conferences">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <Button asChild>
                    <Link to="/conferences#contact-form">
            ...
            <TabsContent value="roundtable">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <Button asChild>
                    <Link to="/roundtable#contact-form">
                      Contact Us <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                  </Button>
                </div>
            ...
            <TabsContent value="data-generation">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <Button asChild>
                    <Link to="/data-generation#contact-form">
                      Contact Us <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                  </Button>
                </div>

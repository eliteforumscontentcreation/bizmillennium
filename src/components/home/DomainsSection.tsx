      ...
      <div className="container-wide relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative h-[500px] md:h-[600px] rounded-3xl overflow-hidden bg-gradient-to-br from-[#1e40af] via-[#3b82f6] to-[#06b6d4] shadow-2xl transform transition-all duration-500 hover:scale-[1.02]">
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-8 md:p-12">
                ...
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm">
                    ...
                    <span className="text-white/90 text-sm font-medium">Featured Domain</span>
                  </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-5 rounded-2xl transition-all duration-300 group ${
                    isSelected 
                      ? 'bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border-2 border-accent shadow-lg scale-[1.02]' 
                      : 'bg-card hover:bg-secondary/50 border-2 border-transparent hover:border-border hover:shadow-md'
                  }`}
                >
                  {/* Icon */}
                  ...
                  <div className="flex-1 text-left">
                    ...
                    {isSelected && (
                      <span className="text-sm text-muted-foreground mt-1 block animate-fade-in">
                        Currently viewing
                      </span>
                    )}
                  </div>
